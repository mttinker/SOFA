...
```{r Table13b, echo=FALSE}

ii = c(which(startsWith(vns,"Pi[")))

kable(Pclass_stats[,-2], row.names = FALSE,
      caption = "Table 13b. Estimates for proportion of diet (consumed biomass) by prey Class (standardized definitions), for the overall data set")
